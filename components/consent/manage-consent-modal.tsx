            ...
            <div className="modal-content">
                ...
                <div className="modal-footer">
                    <button type="button" className="btn btn-secondary" onClick={() => {
                        ...
                        props.onConsentChanged({ categories: { essential: false, analytical: false, marketing: false } });
                    }}>
                        Deselect all
                    </button>
                    <button type="button" className="btn btn-primary" onClick={() => {
                        props.setVisible(false);
                        props.setParentVisible(false);
                        props.onConsentChanged({ categories: { essential: consentStore.essential, analytical: consentStore.analytical, marketing: consentStore.marketing } });
                    }}>Save changes</button>
                </div>
            </div>
        </div>
